...
<body class="flex w-screen h-screen p-5 space-x-6 bg-gray-300">
    ...
    <div class="flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
        <a class="flex items-center w-full px-3 mt-3 " href="#">
            ...
            <span class="ml-2 text-sm font-bold">PKL Stembayo</span>
            
        </a>
        <div class="w-full px-2">
            <div class="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="{{ route('dashboard') }}" wire:navigate>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house-icon lucide-house"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
                    <span class="ml-2 text-sm font-medium">Dasboard</span>
                </a>
                <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="{{ route('siswa') }}" wire:navigate>
                ...
                <a class="flex items-center w-full h-12 px-3 mt-2 hover:bg-gray-300 rounded" href="{{ route('guru') }}" wire:navigate>
                    ...
                    <span class="ml-2 text-sm font-medium">Data Guru</span>
                </a>
                <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="{{ route('industri') }}" wire:navigate>
                    ...
                    <span class="ml-2 text-sm font-medium">Industri</span>
                </a>
            </div>
            <div class="flex flex-col items-center w-full mt-2 border-t border-gray-300">
                <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="{{ route('pkl') }}" wire:navigate>
        ...
        <a class="flex items-center justify-center w-full h-12 mt-auto  hover:bg-gray-300" href="{{ route('settings') }}" wire:navigate>
        ...
        <form method="POST" action="{{ route('logout') }}" class="w-full"> 
            @csrf
            <button type="submit" class="flex items-center justify-center w-full h-16 mt-0 bg-gray-200 hover:bg-gray-300 hover:border hover:border-red-500 rounded">
            <svg class="w-6 h-6 stroke-current text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span class="ml-2 text-sm font-medium text-red-500">Logout</span>
            </button>
        </form>
        </a>
    </div>
    ...
    <div class="flex-grow h-full bg-white rounded p-6">
        {{ $slot }}
    </div>
