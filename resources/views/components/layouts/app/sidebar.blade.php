...
<body class="flex w-screen h-screen p-5 space-x-6 bg-gray-300">
    ...
    <div class="flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
        ...
        <a class="flex items-center justify-center w-full h-12 mt-auto rounded hover:bg-gray-300" href="#">
        ...
        <form method="POST" action="{{ route('logout') }}" class="w-full"> 
            @csrf
            <button type="submit" class="flex items-center justify-center w-full h-16 mt-2 bg-gray-200 hover:bg-gray-300 hover:border hover:border-red-500 rounded">
